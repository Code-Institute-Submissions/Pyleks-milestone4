"""
Django settings for Alex_Digital_Art project.
...
ROOT_URLCONF = 'Alex_Digital_Art.urls'
...
WSGI_APPLICATION = 'Alex_Digital_Art.wsgi.application'
...
if DEBUG_STATUS == '1':
    ...
    DEFAULT_FROM_EMAIL = 'alexdigitalart@example.com'
else:
